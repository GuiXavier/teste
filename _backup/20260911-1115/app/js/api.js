...
var API = (function () {
  ...
  return {
    ...
    categories: function (o, cb) {
      ...
      o = o || {};
      req("GET", "/api/categories" + (o.type ? ("?type=" + o.type) : ""), null, cb);
    },
    seriesInfo: function (id, cb) {
      req("GET", "/api/series/" + encodeURIComponent(id), null, cb);
    },
    ...
    simularOffline: function (on) {
      if (on !== undefined) { simularOffline = !!on; }
